...
public class ReservationController {
    ...
    @PostMapping("/{adId}")
    public ResponseEntity<?> createReservation(@PathVariable Long adId, @RequestBody Reservation reservation){

        Reservation afterCreate = reservationService.createReservation(adId,reservation);
